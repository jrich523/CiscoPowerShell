...
$ModName = "CiscoPowerShell"
$repo = "CiscoPowerShell"
$userid = "jrich523"
...
<#
Run to generate install cmd

write-host "iex (new-object System.Net.WebClient).DownloadString('https://raw.github.com/$userid/$repo/master/Install.ps1')"
